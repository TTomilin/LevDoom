...
LOGS_Level = {
    'health_gathering': {'Level 0': ['default'], \
                         'Level 1': ['lava', 'slime', 'supreme', 'poison', 'obstacles', 'stimpacks', 'shaded_kits',
                                     'resized_kits'], \
...
if __name__ == '__main__':
    ...
    for level in LOGS_Level[cur_group].keys():
        ...
        plt.fill_between(x_steps, np.nanpercentile(total_rewards, 25, axis=0),
                         np.nanpercentile(total_rewards, 75, axis=0), alpha=0.25)
