...
ranges = {
    ...
    'health_gathering': {
        'default': [515, 524],
        'lava': [510, 524], 'water': [310, 324], 'obstacles': [410, 424], 'stimpacks': [410, 424],
        'resized_agent': [450, 524], 'resized_kits': [450, 524], 'shaded_kits': [450, 524], 'supreme': [200, 300],
        'slimy_obstacles': [300, 494], 'shaded_stimpacks': [270, 360], 'supreme_poison': [290, 430],
        'poison_resized_shaded_kits': [200, 300], 'obstacles_slime_stimpacks': [160, 290],
        'lava_supreme_short_agent': [140, 270],
        'complete': [130, 190]
    },
    'seek_and_kill': {
        'default': [0, 15],
        'red': [0, 15], 'blue': [0, 15], 'shadows': [0, 15], 'obstacles': [0, 15], 'invulnerable': [0, 15],
        'mixed_enemies': [0, 15], 'resized_enemies': [0, 15],
        ...
        'blue_mixed_resized_enemies': [0, 15], 'red_obstacles_invulnerable': [0, 15],
        'resized_shadows_invulnerable': [0, 15],
        'complete': [0, 15]
    },
    'dodge_projectiles': {
        'default': [470, 524],
        'barons': [515, 524], 'cacodemons': [510, 524], 'city': [450, 524], 'flames': [450, 524],
        'flaming_skulls': [450, 524], 'resized_agent': [350, 424],
        'arachnotron': [235, 424], 'cacodemons_flames': [235, 424], 'mancubus_resized_agent': [225, 424],
        'revenants': [275, 400], 'city_resized_agent': [225, 330], 'barons_flaming_skulls': [180, 275],
        'flames_flaming_skulls_mancubus': [120, 160], 'resized_agent_revenants': [155, 195],
        'city_arachnotron': [175, 200],
        'complete': [120, 185]
    }
}
...
task_dict = {
    ...
    'seek_and_kill': {
        ...
        2: ['blue_shadows', 'obstacles_resized_enemies', 'red_mixed_enemies', 'invulnerable_blue',
            'resized_enemies_red'],
    ...
    'dodge_projectiles': {
        ...
        2: ['revenants', 'arachnotron', 'city_resized_agent', 'barons_flaming_skulls', 'cacodemons_flames',
            'mancubus_resized_agent'],
...
def plot_tasks(scenario: str, level: int, setting='train', interval=10, seeds=['', '_1111', '_2222', '_3333'],
               n_data_points=50) -> None:
...
def plot_levels_with_seeds(scenario: str, setting='train', n_data_points=20, n_extra_data_points=0, interval=10,
                           scaler=10) -> None:
