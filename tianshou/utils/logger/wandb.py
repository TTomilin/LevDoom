...
class WandbLogger(BaseLogger):
    ...
    :param str project: W&B project name. Default to "LevDoomLab".
    ...
    def __init__(
        ...
        super().__init__(train_interval, test_interval, update_interval, extra_statistics)
        self.last_save_step = -1
        self.save_interval = save_interval
        self.write_flush = write_flush
        self.restored = False
        if project is None:
            project = os.getenv("WANDB_PROJECT", "LevDoomLab")
        ...
        self.wandb_run._label(repo="LevDoomLab")  # type: ignore
