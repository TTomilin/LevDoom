...
class Net(nn.Module):
    ...
    :param bool dueling_param: whether to use dueling network to calculate Q
        ...
        class:`~LevDoomLab.utils.net.common.MLP`. Default to None.
    :param linear_layer: use this module as linear layer. Default to nn.Linear.

    .. seealso::

        Please refer to :class:`~LevDoomLab.utils.net.common.MLP` for more
        detailed explanation on the usage of activation, norm_layer, etc.

        You can also refer to :class:`~LevDoomLab.utils.net.continuous.Actor`,
        :class:`~LevDoomLab.utils.net.continuous.Critic`, etc, to see how it's
        suggested be used.
    """
