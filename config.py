...
def argparser() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--memory-capacity', type=int, default=1e6,
    ...
    parser.add_argument(
        '--render-fps', type=int, default=15,
    ...
    parser.add_argument(
        '--health-loss-penalty', type=float, default=0.1,
        help='Penalty for losing health in a iteration'
    )
    parser.add_argument(
        '--ammo-used-penalty', type=float, default=0.1,
