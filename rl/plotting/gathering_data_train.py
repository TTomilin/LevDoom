...
LOGS = {
    ...
    'health_gathering': ['default', 'lava', 'slime', 'supreme', 'poison', 'obstacles', 'stimpacks', 'shaded_kits',
                         'resized_kits', 'shaded_stimpacks', 'supreme_poison', 'slime_obstacles',
                         'poison_resized_shaded_kits', \
